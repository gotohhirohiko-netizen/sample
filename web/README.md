...
`.github/workflows/deploy-web.yml` により、`main`ブランチの`web/`配下への変更をpushすると自動的にGitHub Pagesへデプロイされる。初回のみ、リポジトリの Settings → Pages → Source を **GitHub Actions** に設定する必要がある。
